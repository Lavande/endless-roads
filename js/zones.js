...
export const ZONE_DEFS = {
  sunset: [
    { key: 'wheat', name: '麦浪旷野', en: 'Wheat Fields', weights: { stalk: 5, tree: 1.4, rock: 0.6 }, density: 1.15, hill: 0.65, tint: '#e9c05a', tintAmt: 0.3 },
    { key: 'windmill', name: '风车丘陵', en: 'Windmill Hills', weights: { stalk: 2.4, tree: 1.0, rock: 0.7, windmill: 3.2 }, density: 0.9, hill: 1.55, tint: '#8fae57', tintAmt: 0.34, scale: { windmill: 1.25 } },
    { key: 'grove', name: '疏林河谷', en: 'Wooded Valley', weights: { tree: 3.8, stalk: 1.4, rock: 0.8 }, density: 1.3, hill: 0.6, tint: '#71914e', tintAmt: 0.34 },
    { key: 'redrock', name: '红岩台地', en: 'Red Rock Mesa', weights: { rock: 3.8, stalk: 2.0, tree: 0.6 }, density: 0.7, hill: 1.3, tint: '#b0603a', tintAmt: 0.42, landmark: 'rock', scale: { rock: 1.3 } },
  ],
  neon: [
    { key: 'downtown', name: '霓虹峡谷', en: 'Neon Canyon', weights: { bldg: 4.6, pillar: 1.4, sign: 1.0 }, density: 1.35, hill: 0.45, tint: '#3a2a78', tintAmt: 0.35, landmark: 'bldg', scale: { bldg: 1.15 } },
    { key: 'industrial', name: '工业环线', en: 'Industrial Loop', weights: { pillar: 2.6, bldg: 1.4, sign: 1.8 }, density: 1.0, hill: 0.6, tint: '#5a4030', tintAmt: 0.3 },
    { key: 'outskirts', name: '电光旷野', en: 'Electric Plains', weights: { pillar: 1.6, sign: 0.9, bldg: 0.5 }, density: 0.5, hill: 1.0, tint: '#16384e', tintAmt: 0.34 },
  ],
  snow: [
    { key: 'forest', name: '雪松林海', en: 'Snow Pine Forest', weights: { pine: 4.6, rock: 0.8 }, density: 1.35, hill: 0.95, tint: '#a4bcd4', tintAmt: 0.3, scale: { pine: 1.1 } },
    { key: 'tundra', name: '冰原旷野', en: 'Frozen Tundra', weights: { pine: 0.6, rock: 1.4 }, density: 0.45, hill: 0.5, tint: '#ffffff', tintAmt: 0.32, landmark: 'rock', scale: { rock: 1.25 } },
    { key: 'pass', name: '雾凇山隘', en: 'Hoarfrost Pass', weights: { pine: 2.2, rock: 2.6 }, density: 1.05, hill: 1.7, tint: '#7e96ae', tintAmt: 0.36, landmark: 'pine', scale: { pine: 1.2, rock: 1.2 } },
  ],
  ink: [
    { key: 'bamboo', name: '竹溪幽谷', en: 'Bamboo Glen', weights: { bamboo: 4.0, rock: 0.9, inkTree: 0.8 }, density: 1.1, hill: 1.1, tint: '#8ca583', tintAmt: 0.3, scale: { bamboo: 1.15 } },
    { key: 'hamlet', name: '古塔乡野', en: 'Pagoda Fields', weights: { inkTree: 2.0, pagoda: 1.2, rock: 0.8 }, density: 0.9, hill: 0.7, tint: '#f0e6c8', tintAmt: 0.3, landmark: 'pagoda' },
    { key: 'peaks', name: '群峰深处', en: 'The High Peaks', weights: { inkTree: 0.9, rock: 1.8 }, density: 0.5, hill: 1.6, tint: '#6f6d66', tintAmt: 0.4, scale: { rock: 1.35, inkTree: 1.15 } },
  ],
};
